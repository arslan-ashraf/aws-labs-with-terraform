...
1. First create a secret in SecretsManager manually using the AWS console.  We don't to manage secrets with Terraform in this project because they can't just be created and deleted arbitrarily.  Normally when you delete a secret, it doesn't get deleted but stays dormant for 7 to 30 days.
